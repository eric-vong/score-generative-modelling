...
error_tolerance = c.error_tolerance
euler_maruyama_num_steps = c.euler_maruyama_num_steps
signal_to_noise_ratio = c.signal_to_noise_ratio
pc_num_steps = c.pc_num_steps
...
def Euler_Maruyama_sampler(
    ...
    diffusion_coeff,
    batch_size=16,
    num_steps=euler_maruyama_num_steps,
    device="cuda",
    eps=1e-3,
):
